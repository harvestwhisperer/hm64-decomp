...
class TextEncoder:
    ...
    def __init__(self, modding: bool = False):
        self.verbose = False
        self.auto_linebreak = modding  # True for modding, False for matching
    ...
    def encode_text(self, text: str, metadata: dict = None) -> bytes:
        ...
        # Add BLOCK_END bytes as additional codes after TEXTEND (matching mode only)
        if not self.modding:
