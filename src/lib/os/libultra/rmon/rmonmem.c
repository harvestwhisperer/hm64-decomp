...
INCLUDE_ASM(const s32, "lib/os/libultra/rmon/rmonmem", rmonmem_text_0074);
...
INCLUDE_ASM(const s32, "lib/os/libultra/rmon/rmonmem", rmonmem_text_022C);

INCLUDE_ASM(const s32, "lib/os/libultra/rmon/rmonmem", __rmonWriteMem);

INCLUDE_ASM(const s32, "lib/os/libultra/rmon/rmonmem", rmonmem_text_0320);

INCLUDE_ASM(const s32, "lib/os/libultra/rmon/rmonmem", rmonmem_text_0368);

INCLUDE_ASM(const s32, "lib/os/libultra/rmon/rmonmem", rmonmem_text_0428);

INCLUDE_ASM(const s32, "lib/os/libultra/rmon/rmonmem", rmonmem_text_0450);
...
INCLUDE_ASM(const s32, "lib/os/libultra/rmon/rmonmem", rmonmem_text_0578);
