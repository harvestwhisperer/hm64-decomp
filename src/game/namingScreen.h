...
#define NAMING_SCREEN_TYPE_PLAYER    0
#define NAMING_SCREEN_TYPE_FARM      1
#define NAMING_SCREEN_TYPE_DOG       2
#define NAMING_SCREEN_TYPE_HORSE     3
#define NAMING_SCREEN_TYPE_BABY      4
#define NAMING_SCREEN_TYPE_COW       5
#define NAMING_SCREEN_TYPE_SHEEP     6
#define NAMING_SCREEN_TYPE_CHICKEN   7
