...
#define ENTITY_ASSET_DOG_RACE 61
#define ENTITY_ASSET_CAT 62
#define ENTITY_ASSET_DOG 63
#define ENTITY_ASSET_DOG_TITLE 64
...
#define ENTITY_MISC_ANIMAL_BASE_INDEX 0xE
#define ENTITY_ITEM_BASE_INDEX 0x27
