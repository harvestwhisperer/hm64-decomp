...
GroundObjectInfo groundObjectsInfo[MAX_FIELD_OBJECTS] = {
    ...
    { 0x04, 0x05, 0x00, GROUND_OBJECT_CUTTABLE | GROUND_OBJECT_WATERABLE, 0x00 },
    { 0x05, 0x05, 0x00, GROUND_OBJECT_CUTTABLE, 0x01 },
    { 0x04, 0x06, TURNIP_HELD_ITEM, GROUND_OBJECT_CUTTABLE | GROUND_OBJECT_WATERABLE, 0x00 },
    { 0x05, 0x06, TURNIP_HELD_ITEM, GROUND_OBJECT_CUTTABLE, 0x02 },
    ...
    { 0x04, 0x08, 0x00, GROUND_OBJECT_CUTTABLE | GROUND_OBJECT_WATERABLE, 0x00 },
    { 0x05, 0x08, 0x00, GROUND_OBJECT_CUTTABLE, 0x01 },
    { 0x04, 0x09, POTATO_HELD_ITEM, GROUND_OBJECT_CUTTABLE | GROUND_OBJECT_WATERABLE, 0x00 },
    { 0x05, 0x09, POTATO_HELD_ITEM, GROUND_OBJECT_CUTTABLE, 0x02 },
    ...
    { 0x04, 0x0C, 0x00, GROUND_OBJECT_CUTTABLE | GROUND_OBJECT_WATERABLE, 0x00 },
    { 0x05, 0x0C, 0x00, GROUND_OBJECT_CUTTABLE, 0x01 },
    { 0x04, 0x0D, EGGPLANT_HELD_ITEM, GROUND_OBJECT_CUTTABLE | GROUND_OBJECT_WATERABLE, 0x00 },
    { 0x05, 0x0D, EGGPLANT_HELD_ITEM, GROUND_OBJECT_CUTTABLE, 0x02 },
    ...
    { 0x04, 0x10, 0x00, GROUND_OBJECT_CUTTABLE | GROUND_OBJECT_WATERABLE, 0x00 },
    { 0x05, 0x10, 0x00, GROUND_OBJECT_CUTTABLE, 0x01 },
    { 0x04, 0x11, CABBAGE_HELD_ITEM, GROUND_OBJECT_CUTTABLE | GROUND_OBJECT_WATERABLE, 0x00 },
    { 0x05, 0x11, CABBAGE_HELD_ITEM, GROUND_OBJECT_CUTTABLE, 0x02 },
    ...
    { 0x04, 0x14, 0x00, GROUND_OBJECT_CUTTABLE | GROUND_OBJECT_WATERABLE, 0x00 },
    { 0x05, 0x14, 0x00, GROUND_OBJECT_CUTTABLE, 0x01 },
    { 0x04, 0x15, STRAWBERRY_HELD_ITEM, GROUND_OBJECT_CUTTABLE | GROUND_OBJECT_WATERABLE, 0x00 },
    { 0x05, 0x15, STRAWBERRY_HELD_ITEM, GROUND_OBJECT_CUTTABLE, 0x02 },
    ...
    { 0x04, 0x19, 0x00, GROUND_OBJECT_CUTTABLE | GROUND_OBJECT_WATERABLE, 0x00 },
    { 0x05, 0x19, 0x00, GROUND_OBJECT_CUTTABLE, 0x01 },
    { 0x04, 0x1A, TOMATO_HELD_ITEM, GROUND_OBJECT_CUTTABLE | GROUND_OBJECT_WATERABLE, 0x00 },
    { 0x05, 0x1A, TOMATO_HELD_ITEM, GROUND_OBJECT_CUTTABLE, 0x02 },
    ...
    { 0x04, 0x1E, 0x00, GROUND_OBJECT_CUTTABLE | GROUND_OBJECT_WATERABLE, 0x00 },
    { 0x05, 0x1E, 0x00, GROUND_OBJECT_CUTTABLE, 0x01 },
    { 0x04, 0x1F, CORN_HELD_ITEM, GROUND_OBJECT_CUTTABLE | GROUND_OBJECT_WATERABLE, 0x00 },
    { 0x05, 0x1F, CORN_HELD_ITEM, GROUND_OBJECT_CUTTABLE, 0x02 },
    ...
    { 0xFF, 0xFF, 0x00, GROUND_OBJECT_CHOPPABLE, 0x00 },
    { 0xFF, 0xFF, 0x00, GROUND_OBJECT_CHOPPABLE, 0x00 },
    { 0xFF, 0x30, MEDICINAL_HERB_HELD_ITEM, GROUND_OBJECT_CUTTABLE, 0x00 },
    { 0xFF, 0x31, EDIBLE_HERB_HELD_ITEM, GROUND_OBJECT_CUTTABLE, 0x00 }, 
    { 0xFF, 0x32, VERYBERRY_HELD_ITEM, GROUND_OBJECT_CUTTABLE, 0x00 },
    { 0xFF, 0x33, TROPICAL_FRUIT_HELD_ITEM, GROUND_OBJECT_CUTTABLE, 0x00 },
    { 0xFF, 0x34, WALNUT_HELD_ITEM, GROUND_OBJECT_CUTTABLE, 0x00 }, 
    { 0xFF, 0x35, WILD_GRAPES_HELD_ITEM, GROUND_OBJECT_CUTTABLE, 0x00 },
    { 0xFF, 0x36, MUSHROOM_HELD_ITEM, GROUND_OBJECT_CUTTABLE, 0x00 },
    { 0xFF, 0x37, POISONOUS_MUSHROOM_HELD_ITEM, GROUND_OBJECT_CUTTABLE, 0x00 },
    { 0xFF, 0x38, BERRY_OF_THE_FULLMOON_HELD_ITEM, GROUND_OBJECT_CUTTABLE, 0x00 }, // berry of fullmoon
    ...
    if (blueMistFlowerPlot) {
        ...
        if (gSeason < AUTUMN) {
            ...
            if (flags & 1) {
                ...
                clearLifeEventBit(BOUGHT_BLUE_MIST_SEEDS);
                clearLifeEventBit(BLUE_MIST_CYCLE_ACTIVE);
            }
            ...
            clearLifeEventBit(BOUGHT_BLUE_MIST_SEEDS);
            clearLifeEventBit(BLUE_MIST_CYCLE_ACTIVE);
            clearLifeEventBit(BLUE_MIST_COMPLETE);
        }
