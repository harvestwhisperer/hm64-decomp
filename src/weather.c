...
extern u32 rainPalette_ROM_START;
extern u32 rainPalette_ROM_END;
...
void func_800DC360(void) {
    ...
    if (check != 0xFF) {
        ...
        for (i = 0; i < 10; i++) {
            ...
            // sprite funcs
            func_8002B138(i+0x6B, &rainTexture_ROM_START, &rainTexture_ROM_END, &rainPalette_ROM_START, &rainPalette_ROM_END, 0, 0, (void*)RAIN_TEXTURE_VADDR, NULL, 0x802A5DC0, 0x802A5EC0, 0x802A5FC0, 0, 0, 1);
