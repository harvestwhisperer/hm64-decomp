...
//INCLUDE_ASM(const s32, "system/sprite", resetSpriteAddressesFlags);
...
//INCLUDE_ASM(const s32, "system/sprite", setSpriteAddresses);
...
//INCLUDE_ASM(const s32, "system/sprite", dmaSprites);
