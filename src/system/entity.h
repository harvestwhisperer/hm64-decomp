...
extern bool updateEntityRGBA(u16 index, u8 r, u8 g, u8 b, u8 a, s16 arg5);
...
extern bool setEntityPaletteIndex(u16 index, s16);
extern bool func_8002FF38(u16, u16);
extern bool setEntityCollisionBuffers(u16 spriteIndex, u8 xValue, u8 yValue);
...
extern bool checkEntityShouldPlaySoundEffect(u16);   
extern bool func_80031830(u16, u32, u8);        
extern Vec3f* func_80031904(Vec3f* vec, u16 index, s16, u8);
extern bool setEntityAnimationWithDirectionChange(u16 index, u16);
