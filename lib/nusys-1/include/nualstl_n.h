...
/* Default audio heap was 0x80000 (512 KB) based at NU_GFX_FRAMEBUFFER_ADDR -
 * 0x80000 = 0x8030F800. That address collides with yay0ScratchBuffer in spec,
 * which means audio synthesis output buffers overwrote the compressed source
 * mid-decode, producing the "tail 30% garbage" corruption. Shrunk by 0x10000
 * (64 KB) to push the heap base up to 0x8031F800, immediately after
 * yay0ScratchBuffer (0x8030F800 + 0x10000). */
#define NU_AU_HEAP_SIZE		0x70000
