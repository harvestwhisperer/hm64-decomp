...
// TODO: move this the code segment and have mkldscript handle the STACK argument and BOOT flags
beginseg
    name "entry"
    address 0x80025C00
...
beginwave
    ...
    include "levelInteractionsText"
    include "levelInteractionsTextIndex"
    ...
    include "ranchCutscenesText"
    include "ranchCutscenesTextIndex"
    include "funeralIntroText"
    include "funeralIntroTextIndex"
    include "fireworksFestivalText"
    include "fireworksFestivalTextIndex"
    include "flowerFestivalText"
    include "flowerFestivalTextIndex"
    include "seaFestivalAndEvaluationText"
    include "seaFestivalAndEvaluationTextIndex"
    include "cowFestivalText"
    include "cowFestivalTextIndex"
    include "fireflyFestivalText"
    include "fireflyFestivalTextIndex"
    include "dogRaceText"
    include "dogRaceTextIndex"
    include "mountainCutscenesText"
    include "mountainCutscenesTextIndex"
    include "sowingFestivalText"
    include "sowingFestivalTextIndex"
    include "harvestFestivalText"
    include "harvestFestivalTextIndex"
    ...
    include "village1CutscenesText"
    include "village1CutscenesTextIndex"
    include "village2CutscenesText"
    include "village2CutscenesTextIndex"
    include "karenranchCutscenesText"
    include "karenranchCutscenesTextIndex"
    include "roadCutscenesText"
    include "roadCutscenesTextIndex"
    include "farmVisitsText"
    include "farmVisitsTextIndex"
    include "houseCutscenesText"
    include "houseCutscenesTextIndex"
    ...
    include "ranchCutscenesDialogue"
    include "ranchCutscenesDialogueIndex"
    include "fireworksFestivalDialogue"
    include "fireworksFestivalDialogueIndex"
    include "flowerFestivalDialogue"
    include "flowerFestivalDialogueIndex"
    include "seaFestivalAndEvaluationDialogue"
    include "seaFestivalAndEvaluationDialogueIndex"
    include "cowFestivalDialogue"
    include "cowFestivalDialogueIndex"
    include "fireflyFestivalDialogue"
    include "fireflyFestivalDialogueIndex"
    ...
    include "mountainCutscenesDialogue"
    include "mountainCutscenesDialogueIndex"
    include "sowingFestivalDialogue"
    include "sowingFestivalDialogueIndex"
    include "harvestFestivalDialogue"
    include "harvestFestivalDialogueIndex"
    include "horseRaceDialogue"
    include "horseRaceDialogueIndex"
    include "karenranchCutscenesDialogue"
    include "karenranchCutscenesDialogueIndex"
    include "roadCutscenesDialogue"
    include "roadCutscenesDialogueIndex"
    include "farmVisitstext64Dialogue"
    include "farmVisitsDialogueIndex"
    include "houseCutscenesDialogue"
    include "houseCutscenesDialogueIndex"
    include "eggFestivalDialogue"
    include "eggFestivalDialogueIndex"
    include "village1CutscenesDialogue"
    include "village1CutscenesDialogueIndex"
    include "village2CutscenesDialogue"
    include "village2CutscenesDialogueIndex"
    ...
    include "mrsManaDialogue"
    include "mrsManaDialogueIndex"
    include "johnDialogue"
    include "johnDialogueIndex"
    include "gourmetJudgeDialogue"
    include "gourmetJudgeDialogueIndex"
    include "npcBabyDialogue"
    include "npcBabyDialogueIndex"
    include "libraryDialogue"
    include "libraryDialogueIndex"
    include "entomologistDialogue"
    include "entomologistDialogueIndex"
